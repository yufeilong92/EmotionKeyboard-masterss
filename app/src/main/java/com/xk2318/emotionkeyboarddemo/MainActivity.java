    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String sms = new GlobalOnItemClickManager().getSms();
                Log.d("==:", "sms: " + sms);
                if (sms != null) {

                    SpannableString emotionContent = SpanStringUtils.getEmotionContent(MainActivity.this, contentView, sms);
                    contentView.setText(emotionContent);
                } else {
                    String s = edittext.getText().toString();
                    SpannableString emotionContent = SpanStringUtils.getEmotionContent(MainActivity.this, contentView, s);
                    contentView.setText(emotionContent);
                }
            }
        });
...
//        contentView = (ImageView) findViewById(R.id.txt_main_content);
